(function (e) {
            ...
            function r() {
                ...
                return a ? (i++, _.send_offer(a).then(function (s) {
                    return n.on_offer_response && n.on_offer_response(a.obj, s), void 0 === s ? r() : new Promise(function (e) {
                        function d() {
                            ...
                            e.onprogress = function (r) {
                                ...
                                o = new Uint8Array(d.target.result, s, o), t(_), s.end(o).then(function () {
                                    n.on_progress && o.length && n.on_progress(a.obj, s, o), n.on_file_complete && n.on_file_complete(a.obj, s), postMessage(r())
                                })
                            }
                        }
                        ...
                        var i = new Blob([o], {type: 'application/javascript'}), d = new Worker(URL.createObjectURL(i));
    ...
    var r = e.exports;
    Object.assign(r, n(2), n(10), n(3), n(0), n(11), n(13), n(14), n(1));
    ...
    r.Session = class extends l {
        ...
        _consume_header(e) {
            this._on_receive(e);
            var _ = this._next_header_handler[e.NAME];
        ...
        _check_for_abort_sequence() {
            ...
            if (-1 !== e) throw this._input_buffer.splice(0, e + i.length), this._aborted = !0, this._on_session_end(), new r.Error('peer_aborted')
        }

        _send_header() {
            if (!this._sender) throw'Need sender!';
            var e = Array.apply(null, arguments), _ = this._create_header_bytes(e);
            this._sender(_[0]), this._last_sent_header = _[1]
        }
        ...
        _parse_and_consume_subpacket() {
            ...
            return _ && (this._consume_data(_), _.frame_end() && (this._next_subpacket_handler = null)), _
        }
                ...
                _._next_header_handler = {
                    ZDATA: function (_) {
                        this._consume_ZDATA(_), this._next_subpacket_handler = this._consume_ZDATA_data, this._next_header_handler = {
                            ZEOF: function (_) {
                                this._next_subpacket_handler = null, this._consume_ZEOF(_);
                                var n = this._make_promise_for_between_files();
                                e(n)
                            }
                        }
                    }
    ...
    class p {
        constructor(e, _, n, t) {
            this._file_info = e, this._file_offset = _ || 0, this._send = n, this._end = t
        }
    ...
    r.Session.Send = class extends r.Session {
        ...
        send_offer(e) {
            ...
            var _ = this._convert_params_to_offer_payload_array(e);
            this._stop_keepalive();
            var n = this, t = function () {
                var t = new Promise(function (_) {
                    n._next_header_handler = {
                        ZSKIP: function () {
                            n._start_keepalive(), _()
                        }, ZRPOS: function (t) {
                            n._sending_file = !0, _(new p(e, t.get_offset(), n._send_interim_file_piece.bind(n), n._end_file.bind(n)))
                        }
                    }
                });
                return n._send_header_and_data(['ZFILE'], _, 'end_ack'), delete n._sent_ZDATA, t
            };
            return this._ensure_receiver_escapes_ctrl_chars().then(t)
        }

        _send_header_and_data(e, _, n) {
            var t = this._create_header_bytes(e), r = this._build_subpacket_bytes(_, n);
            t[0].push.apply(t[0], r), this._sender(t[0]), this._last_sent_header = t[1]
        }
        ...
        _send_file_part(e, _) {
            ...
            for (var n = 0, t = e.length; ;) {
                ...
                if (s instanceof Array || (s = Array.prototype.slice.call(s)), this._build_and_send_subpacket(s, a ? _ : 'no_end_no_ack'), this._file_offset += r, n += r, n >= t) break
            }
        }
    ...
    function t(e) {
        if (!I[e]) throw new c.Error('Invalid ZRINIT flag: ' + e);
        return I[e]
    }
    ...
    function s(e) {
        return e.prototype instanceof S ? new e(0) : new e([])
    }

    function d(e) {
        var _ = c.ZDLE.splice(e, g.length, 7);
        return _ && o(_)
    }
    ...
    const p = 42, f = 65, u = 67, h = [13, 10], b = h.slice(0).concat([c.ZMLIB.XON]), m = [p, p, c.ZMLIB.ZDLE, 66],
        g = [p, c.ZMLIB.ZDLE, f], y = [p, c.ZMLIB.ZDLE, u];
    c.Header = class {
            ...
            TRIM_LOOP:for (; e.length && !n;) {
                ...
                if (-1 === r) {
                    ...
                    if (t.push.apply(t, e.splice(0, r)), 2 > e.length) break TRIM_LOOP; else if (e[1] === p) {
                        if (!(e.length < m.length)) e[2] === m[2] && e[3] === m[3] && (n = l); else if (e.join() === m.slice(0, e.length).join()) break TRIM_LOOP;
                    } else if (e[1] === c.ZMLIB.ZDLE) {
                        if (e.length < g.length) break TRIM_LOOP;
                        e[2] === g[2] ? n = d : e[2] === y[2] && (n = i)
                    }
                    n || t.push(e.shift())
                }
            }
        ...
        to_hex() {
            ...
            return m.concat(c.ENCODELIB.octets_to_hex(e.concat(c.CRC.crc16(e))), this._hex_header_ending)
        }

        to_binary16(e) {
            return this._to_binary(e, g, c.CRC.crc16)
        }
    ...
    class Z extends c.Header {
    }

    const I = {CANFDX: 1, CANOVIO: 2, CANBRK: 4, CANCRY: 8, CANLZW: 16, CANFC32: 32, ESCCTL: 64, ESC8: 128};
    ...
    class E extends c.Header {
        ...
        can_full_duplex() {
            return !!(this._bytes4[3] & I.CANFDX)
        }

        can_overlap_io() {
            return !!(this._bytes4[3] & I.CANOVIO)
        }

        can_break() {
            return !!(this._bytes4[3] & I.CANBRK)
        }

        can_fcs_32() {
            return !!(this._bytes4[3] & I.CANFC32)
        }

        escape_ctrl_chars() {
            return !!(this._bytes4[3] & I.ESCCTL)
        }

        escape_8th_bit() {
            return !!(this._bytes4[3] & I.ESC8)
        }
    }
    ...
    C.prototype._hex_header_ending = h;
    const x = {
        extended: {sparse: 64},
    ...
    }, O = ['extended', 'transport', 'management', 'conversion'];

    class N extends c.Header {
        get_options() {
            var e = {sparse: !!(this._bytes4[0] & 64)}, _ = this._bytes4.slice(0);
            return O.forEach(function (n, t) {
                if (x[n] instanceof Array) 'management' === n && (e.skip_if_absent = !!(_[t] & 128), _[t] &= 31), e[n] = x[n][_[t]]; else for (var r in x[n]) e[r] = !!(_[t] & x[n][r]), e[r] && (_[t] ^= x[n][r]);
    ...
    T.prototype._hex_header_ending = h;

    class S extends c.Header {
        constructor(e) {
    ...
    const B = [[Z, 'ZRQINIT'], [E, 'ZRINIT'], [v, 'ZSINIT'], [C, 'ZACK'], [N, 'ZFILE'], [A, 'ZSKIP'], void 0, [L, 'ZABORT'], [T, 'ZFIN'], [D, 'ZRPOS'], [M, 'ZDATA'], [F, 'ZEOF'], [R, 'ZFERR'], void 0, void 0, void 0, void 0, void 0, void 0, void 0];
    for (var H = {}, z = 0; z < B.length; z++) B[z] && (H[B[z][1]] = B[z][0], Object.assign(B[z][0].prototype, {
        TYPENUM: z,
        NAME: B[z][1]
    }));
    const j = [Z, E, v, C, N, A, 'ZNAK', L, T, D, M, F, R, 'ZCRC', 'ZCHALLENGE', 'ZCOMPL', 'ZCAN', 'ZFREECNT', 'ZCOMMAND', 'ZSTDERR'];
